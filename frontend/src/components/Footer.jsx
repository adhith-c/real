...
function Footer() {
  return (
    ...
    //   <div className="flex justify-between flex-row max-w-[1200px] mx-auto ">
    //     <div className="mx-10 mt-3 text-slate-300">
    //       <h2 className="font-Jost text-2xl font-medium">ABOUT US</h2>

    //       <p className="font-Jost text-sm w-1/3">
    ...
    //       <ul>
    //         <li className="font-Jost text-sm mt-1">For Sale</li>
    //         <li className="font-Jost text-sm mt-1">For Rent</li>
    //         <li className="font-Jost text-sm mt-1">For Vacational Rent</li>
    //       </ul>
    //     </div>
    //     <div className="mx-10 mt-3 text-slate-300">
    //       <h2 className="font-Jost text-2xl font-medium">CONTACT US</h2>
    //       <ul>
    //         <li className="font-Jost text-sm mt-1">underdmn@gmail.com</li>
    //         <li className="font-Jost text-sm mt-1">+91 8137845214</li>
    //         <li className="font-Jost text-sm mt-1">
